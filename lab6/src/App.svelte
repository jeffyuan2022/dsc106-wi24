    ...
    function update_station_markers() {
        ...
        station_markers
            ...
            .style("fill", function (d) {
                let arrivalCount = arrivals[d["station_id"]];
                let departureCount = departures[d["station_id"]];
                let ratio = (arrivalCount + 1) / (departureCount + arrivalCount + 1);
                return colorScale(ratio * 2); 
            });
    }
